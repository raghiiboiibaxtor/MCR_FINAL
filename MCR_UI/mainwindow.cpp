...
void MainWindow::addCertificateImage()
{
    ...
    if(fileName != "")
    {
        ...
        QFile outputFile("TextFiles/vaxCertificates.txt");
...
void MainWindow::addQRCodeImage()
{
    ...
    if(fileName != "")
    {
        ...
        QFile outputFile("TextFiles/issuedQRCodes.txt");
...
void MainWindow::addTestResultImage()
{
    ...
    if(fileName != "")
    {
        ...
        QFile outputFile("TextFiles/issuedTestResults.txt");
...
void MainWindow::addUserPicture()
{
    ...
    if(fileName != "")
    {
        ...
        QFile outputFile("TextFiles/ProfilePictures.txt");
...
void MainWindow::saveUser()
{
    ...
    if (addName.trimmed() != "" && addNhi.trimmed() != "" && addEmail.trimmed() != "")
    {
        ...
        // Writing to file
        /// Windows File Path
        QFile outputFile("TextFiles/Citizens.txt");
        /// Mac File Path
...
void MainWindow::pbReports()
{
    ...
    QFile inputFile("TextFiles/GeneralEnquiries.txt");
    inputFile.open(QIODevice::ReadOnly | QIODevice:: Text);
    QTextStream read(&inputFile);
...
void MainWindow::searchCategory()
{
    ...
    else if (search == "COVID-19 Vaccine")
    {
        // Writing to file
        /// Windows File Path
        QFile inputFile("TextFiles/COVID19Vaccine.txt");
        /// Mac File Path
    ...
    else if (search == "Change/Update Personal Details")
    {
        // Writing to file
        /// Windows File Path
        QFile inputFile("TextFiles/ChangePersonalDetails.txt");
        /// Mac File Path
    ...
    else if (search == "My COVID Record Application")
    {
        // Writing to file
        /// Windows File Path
        QFile inputFile("TextFiles/COVIDRecordApp.txt");
        /// Mac File Path
    ...
    else
    {
        // Writing to file
        /// Windows File Path
        QFile inputFile("TextFiles/Other.txt");
        /// Mac File Path
